...
<script type="text/javascript">	 
	 function chongzhi() {
		document.getElementById('doc-vld-msg').action ="<%=path%>/cz/cz.do";		 
		...
		<form action="" class="am-form" id="doc-vld-msg" method="post" >
			<div class="tr_rechbox">
				...
				<div class="tr_rechli am-form-group">
					<ul class="ui-choose am-form-group"style="text-align: center;overflow: " id="uc_01">
						<li>
							<label class="am-radio-inline">
									<input type="radio"  value="" name="docVlGender" required data-validation-message="请选择一项充值额度"> <font size="3px"><b>5个</b></font>
								</label>
						</li>
						<li>
							<label class="am-radio-inline">
									<input type="radio" name="docVlGender" data-validation-message="请选择一项充值额度"> <font size="3px"><b>10个</b></font>
								</label>
						</li>

						<li>
							<label class="am-radio-inline">
									<input type="radio" name="docVlGender" data-validation-message="请选择一项充值额度"> <font size="3px"><b>30个</b></font>
								</label>
						</li>
