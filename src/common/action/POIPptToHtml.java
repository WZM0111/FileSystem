...
public class POIPptToHtml {
	...
	public static String toImage2007(String sourcePath, String targetDir, String pptFileName) throws Exception {
		...
		sb.append("<title>文件打开</title> </head><body>");
		for (int i = 0; i < ppt.getSlides().size(); i++) {
			try {
				...
				//String imageDir ="\\" + pptFileName + "\\";
				//String imageDir = "\\ppthtml\\" + pptFileName + "\\";
				FileUtils.createDir(imageDir);// create image dir
				String imagePath = imageDir +"-" + (i + 1) + ".png";
				sb.append("<br>");
				sb.append("<img src=" + "\"" +"\\files\\upload\\html" + "\\" + pptFileName + "\\"+"-" + (i + 1) + ".png"+  "\"" + "/>");
